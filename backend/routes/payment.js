...
router.post('/notification', async (req, res) => {
  try {
    ...
    // If payment successful, create/update user and send email
    if (newStatus === 'paid') {
      ...
      // TODO: Trigger server provisioning here
      console.log(`Payment successful for ${order.userEmail}, package: ${order.packageType}`);
    }
